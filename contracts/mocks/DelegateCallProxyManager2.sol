...
/* ---  Proxy Contracts  --- */
import "@indexed-finance/proxies/contracts/ManyToOneImplementationHolder.sol";
import { DelegateCallProxyManyToOne } from "@indexed-finance/proxies/contracts/DelegateCallProxyManyToOne.sol";
import { DelegateCallProxyOneToOne } from "@indexed-finance/proxies/contracts/DelegateCallProxyOneToOne.sol";
...
/* ---  Inheritance  --- */
import "@indexed-finance/proxies/contracts/Owned.sol";
 ...
 */
contract DelegateCallProxyManager2 is Owned, IDelegateCallProxyManager {
/* ---  Constants  --- */
...
/* ---  Proxy Deployment  --- */
    ...
    returns(address proxyAddress)
  {
    ...
    console.log("PM: Deployed address:", proxyAddress);
...
/* ---  Queries  --- */
  ...
  */
    ...
    returns (address)
  {
    ...
    console.log("PM: Deriving MT1 address");
    console.log("Got originator -", originator);
    console.log("Got implementationID -", uint256(implementationID));
    console.log("Got suppliedSalt -", uint256(suppliedSalt));
    bytes32 salt = Salty.deriveManyToOneSalt(
      originator,
      implementationID,
      suppliedSalt
    );
    address derivedAddress = Create2.computeAddress(salt, MANY_TO_ONE_CODEHASH);
    console.log("PM: Derived address:", derivedAddress);
